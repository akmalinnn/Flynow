...
constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    // seats Drawable
    private var bookDrawable = R.drawable.bg_seats_book
    private var bookedDrawable = R.drawable.bg_seats_booked
    private var reservedDrawable = R.drawable.bg_seats_reserved
    private var selectedDrawable = R.drawable.bg_seats_selected
    ...
    init {
        ...
        inflate(context, R.layout.activity_choose_seat, this)
        viewGroupLayout = findViewById(R.id.layout_chooseSeat)
